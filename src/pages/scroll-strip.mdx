...
import { ScrollStripBooksVerticalDemo } from '@/registry/new-york/examples/scroll-strip-books-vertical-demo'
...
The simplest case is the one in [Usage](#usage) above: plain images, each
filling the expanded box and seen through the sliver while collapsed. Scroll to
browse; the strip settles and expands the nearest frame.
