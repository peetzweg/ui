      ...
      <main className="flex flex-col flex-1 gap-8">
        <section className="flex flex-col gap-4 border rounded-lg p-4 min-h-[280px] relative">
          <div className="flex items-center justify-between">
            ...
            <OpenInV0Button name="multi-state-button" className="w-fit" />
          </div>
        ...
        <section className="flex flex-col gap-4 border rounded-lg p-4 min-h-[280px] relative">
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <p className="text-sm text-muted-foreground">
                Seven-state transaction-submission preset over
                MultiStateButton. Idle → ready → signing → broadcasting →
                bestBlock → finalized / failed.
              </p>
            </div>
            <OpenInV0Button name="transaction-button" className="w-fit" />
          </div>
          <div className="flex items-center justify-center min-h-[160px] relative">
